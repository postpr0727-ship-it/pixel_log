...
const services = [
  {
    ...
    gradient: 'from-black/80 to-black/90',
...
function BentoCard({ service, index }: { service: typeof services[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-[2rem] border border-navy/20 bg-white/50 backdrop-blur-sm hover:border-navy/60 transition-colors duration-500 ${service.gridClass}`}
