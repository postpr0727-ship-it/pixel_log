    ...
    <section className="py-16 lg:py-24 bg-muted/30">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="section-title text-navy mt-2 mb-4">상담 신청</h2>
        ...
        <motion.div
          ...
          className="bg-white p-8 lg:p-10 rounded-2xl shadow-sm border border-border/50"
        >
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="mt-6 p-5 bg-background rounded-lg border border-border/50 text-center space-y-1">
                <p className="text-sm font-medium text-navy">
                  📌 PIXEL-LOG는 준앤준솔루션의 전문 디자인/개발 브랜드입니다.
                </p>
                <p className="text-sm text-muted-foreground">
                  계약 및 세금계산서 발행은 <span className="font-semibold text-navy">준앤준솔루션</span> 명의로 진행됩니다.
                </p>
              </div>
            </form>
          </Form>
